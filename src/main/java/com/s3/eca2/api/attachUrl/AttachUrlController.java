...
public class AttachUrlController {
    ...
    public ResponseEntity<String> selectByDate(@RequestParam("start") @DateTimeFormat(pattern = "yyyy-MM-dd") Date start,
        ...
        try {
            ...
            String s3Key = "cs/dev/eca_ct_attach_url_tm/base_dt=" + formattedDateForPath + "/eca_ct_attach_url_tm/parquet/eca_ct_attach_url_tm_" + formattedDateForFileName + "_1.parquet";
